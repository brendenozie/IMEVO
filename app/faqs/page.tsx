...
export default function FAQsPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes! IMEVOis fully mobile responsive and works seamlessly on smartphones and tablets. You can access all features and receive notifications on the go.",
    },
    {
      ...
      <main className="min-h-screen bg-white dark:bg-black">
        ...
        <section className="max-w-4xl mx-auto px-4 py-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Find answers to common questions about IMEVOand our trading
            signals.
          </p>
        </section>
