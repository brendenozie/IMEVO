      ...
      <main className="min-h-screen bg-white dark:bg-black">
        ...
        <section className="max-w-4xl mx-auto px-4 pb-16 text-gray-700 dark:text-gray-300 space-y-8">
          <div>
            ...
            <p>
              By accessing and using the IMEVOwebsite and mobile application,
          ...
          <div>
            ...
            <p className="mb-3">
              IMEVOgrants you a limited, non-exclusive, non-transferable
          ...
          <div>
            ...
            <p>
              THE MATERIALS ON IMEVOWEBSITE AND MOBILE APPLICATION ARE
              PROVIDED ON AN &quot;AS IS&quot; BASIS. IMEVOMAKES NO
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              provided by IMEVOare educational in nature and should not be
          ...
          <div>
            ...
            <p className="mb-3">
              IMEVOoffers subscription plans (Weekly, Monthly, 3 Months). By
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Charges will appear on your payment method as &quot;IMEVO&quot;
              </li>
              <li>
          ...
          <div className="bg-green-50 dark:bg-green-900 p-6 rounded-lg">
            <p className="text-sm">
              By using IMEVO, you acknowledge that you have read these
