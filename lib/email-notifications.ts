...
export const sendEmail = async (options: EmailOptions): Promise<boolean> => {
  try {
    ...
    const fromEmail = process.env.SMTP_FROM_EMAIL || "noreply@IMEVO.com";
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="footer">
            <p>
              © 2025 IMEVO. All rights reserved.<br>
...
export const sendAdminWelcomeEmail = async (
  ...
  const html = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>👋 Welcome to IMEVO Admin</h1>
        </div>
        <div class="content">
          <p>Hi <strong>${adminName}</strong>,</p>
          
          <p>Your admin account has been successfully created! You now have access to the IMEVO admin dashboard.</p>
  ...
  return sendEmail({
    to: email,
    subject: `👋 Welcome to IMEVO Admin - Your Account is Ready`,
    html,
...
export const sendSubscriptionRenewedEmail = async (
  ...
  return sendEmail({
    to: email,
    subject: `✅ Your IMEVO Subscription Renewed - ${planName}`,
    html,
...
export const sendSubscriptionExpiringEmail = async (
  ...
  return sendEmail({
    to: email,
    subject: `⏰ Your IMEVO Subscription Expires in ${daysRemaining} Days`,
    html,
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>This tool is now available for you to use in the IMEVO dashboard. Check it out and start using it right away!</p>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p style="color: #666; margin-top: 30px;">
            Need help? Contact our support team at support@IMEVO.com
          </p>
